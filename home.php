	...
	?>
            ...
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
                ...
                <div class="col-xs-3"><a href="delete_post.php<?php echo '?id='.$id; ?>" name="del1" class="btn btn-danger"><i class="icon-trash"></i> Delete</a>
                    <a href="edit_post.php<?php  ?>" class="btn btn-facebook" name="ed1"><i class="icon-anchor"></i> Edit</a>
